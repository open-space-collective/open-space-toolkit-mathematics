...
if [[ ! -z $1 ]] && [[ $1 == "--link" ]]; then
    ...
    && ln -s /opt/library-core/libboost_python36.so.1.68.0 /opt/conda/lib/python3.6/site-packages/Library/Core/libboost_python36.so.1.68.0 \
    ...
    && ln -s /opt/lib/libboost_python36.so.1.68.0 /opt/conda/lib/python3.6/site-packages/Library/Mathematics/libboost_python36.so.1.68.0 \
