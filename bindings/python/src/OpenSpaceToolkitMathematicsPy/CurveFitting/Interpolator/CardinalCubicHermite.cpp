...
inline void OpenSpaceToolkitMathematicsPy_CurveFitting_Interpolator_CardinalCubicHermite(pybind11::module& aModule)
{
    ...
    class_<CardinalCubicHermite, Interpolator, Shared<CardinalCubicHermite>>(aModule, "CardinalCubicHermite")

        .def(
            init<const VectorXd&, const VectorXd&, const VectorXd&>(),
            R"doc(
                Create a cardinal cubic Hermite interpolator with data points and their first derivatives.
                ...
                Example:
                    ...
                    >>> interpolator = CardinalCubicHermite(x, y, dydx)
            )doc",
            arg("x"),
            arg("y"),
            arg("dydx")
        ...
        .def(
            ...
            R"doc(
                Create a cardinal cubic Hermite interpolator with uniform spacing.
                ...
                Example:
                    >>> y = np.array([0.0, 1.0, 4.0, 9.0])
                    >>> dydx = np.array([0.0, 2.0, 4.0, 6.0])
                    >>> interpolator = CardinalCubicHermite(y, dydx, 0.0, 1.0)  # x = [0, 1, 2, 3]
            )doc",
            arg("y"),
            arg("dydx"),
            arg("x_0"),
        ...
        .def(
            "evaluate",
            overload_cast<const VectorXd&>(&CardinalCubicHermite::evaluate, const_),
            R"doc(
                Evaluate the cardinal cubic Hermite interpolation at multiple points.
                ...
                Example:
                    >>> interpolator = CardinalCubicHermite([0.0, 1.0], [0.0, 2.0], 0.0, 1.0)
        ...
        .def(
            "evaluate",
            overload_cast<const double&>(&CardinalCubicHermite::evaluate, const_),
            R"doc(
                Evaluate the cardinal cubic Hermite interpolation at a single point.
        ...
        .def(
            "compute_derivative",
            overload_cast<const double&>(&CardinalCubicHermite::computeDerivative, const_),
            R"doc(
                Compute the derivative of the cardinal cubic Hermite interpolation at a single point.
        ...
        .def(
            "compute_derivative",
            overload_cast<const VectorXd&>(&CardinalCubicHermite::computeDerivative, const_),
            R"doc(
                Compute the derivative of the cardinal cubic Hermite interpolation at multiple points.
