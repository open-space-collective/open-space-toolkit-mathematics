...
inline void                     OpenSpaceToolkitMathematicsPy_Geometry_Angle   (        pybind11::module&           aModule                                     )
{
    ...
    // Define constructor
    angle.def(init<Real, Angle::Unit>(), arg("value"), arg("unit"))
        ...
        .def_static("between", overload_cast<const Vector2d&, const Vector2d&>(&Angle::Between), arg("first_vector"), arg("second_vector"))
        .def_static("between", overload_cast<const Vector3d&, const Vector3d&>(&Angle::Between), arg("first_vector"), arg("second_vector"))
