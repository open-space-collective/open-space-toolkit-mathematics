...
// Eigen Matrix to Python (MatrixXf or MatrixXd)
...
struct EigenMatrixToPython
{
    ...
    static PyObject* convert (const MatType& mat)
    {
        ...
        // if ((mat.rows() == 1) || (mat.cols() == 1)) @lucas Failed attempt to flatten VectorXd...
        // {

        //     if (mat.cols() == 1)
        //     {

        //         npy_intp shape[2] = { mat.cols(), mat.rows() } ;
        //         PyArrayObject* python_array = (PyArrayObject*)PyArray_SimpleNew(1, shape, NumpyEquivalentType<typename MatType::Scalar>::type_code) ;
        ...
        PyArrayObject* python_array = (PyArrayObject*)PyArray_SimpleNew(2, shape, NumpyEquivalentType<typename MatType::Scalar>::type_code) ;
