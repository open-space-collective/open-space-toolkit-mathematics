...
def test_geometry_d2_objects_point_set_constructor ():
...
def test_geometry_d2_objects_point_set_empty ():
...
def test_geometry_d2_objects_point_set_comparators ():
...
def test_geometry_d2_objects_point_set_get_size ():
...
# def test_geometry_d2_objects_point_set_is_near ():

# def test_geometry_d2_objects_point_set_get_point_closest_to ():

# def test_geometry_d2_objects_point_set_to_string ():

# def test_geometry_d2_objects_point_set_apply_transformation ():
