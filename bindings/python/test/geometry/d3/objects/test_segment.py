...
def test_geometry_d3_objects_segment_constructor ():
...
def test_geometry_d3_objects_segment_defined ():
...
def test_geometry_d3_objects_segment_degenerate ():

    point_1: Point = Point(-1.0, 1.0, 3.4)
...
def test_geometry_d3_objects_segment_comparators ():
...
def test_geometry_d3_objects_segment_getters ():
...
# def test_geometry_d3_objects_segment_to_string ():

# def test_geometry_d3_objects_segment_apply_transformation ():
